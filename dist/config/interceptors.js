...
var debugDB = require('debug')('db:errors');
var debug = require('debug')('errors');

// map MySQL error codes to HTTP status codes
var map = {
  ER_DUP_KEY: 'A key collided in a unique database field.  Please retry your action.  If\n    the problem persists, contact the developers.',
  ...
  ER_PARSE_ERROR: 'Your request could not  be translated into valid SQL.  Please modify your\n    request and try again.',
  ER_EMPTY_QUERY: 'Your request had an empty body.',
  ER_NO_DEFAULT_FOR_FIELD: 'You did not include enough information in your query.',
  ER_DATA_TOO_LONG: 'The value provided is longer than the database record limit.'
};
